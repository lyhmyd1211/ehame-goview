...
import { groupTitle, modalGroupTitle } from '@/settings/designSetting'
...
export class PublicModalGroupConfigClass extends PublicGroupConfigClass implements CreateComponentGroupType {
